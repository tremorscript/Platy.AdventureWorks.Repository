...
public string WriteCode()
{
    ...
    CodeBuilder.AppendLine("using AdventureWorks.Repository.BaseRepository;");
    CodeBuilder.AppendLine("using AdventureWorks.Repository.Data.Entities;");
    CodeBuilder.AppendLine("using AdventureWorks.Repository.Domain.Models;");
    CodeBuilder.AppendLine("using AdventureWorks.Repository.Events;");
