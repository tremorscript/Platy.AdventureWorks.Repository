...
/// <summary>
/// Allows configuration for an entity type <see cref="AdventureWorks.Repository.Data.Entities.ProductModelProductDescriptionCulture" />
/// </summary>
...
{
    /// <summary>
    /// Configures the entity of type <see cref="AdventureWorks.Repository.Data.Entities.ProductModelProductDescriptionCulture" />
    /// </summary>
    ...
    {
        /// <summary>Table Schema name constant for entity <see cref="AdventureWorks.Repository.Data.Entities.ProductModelProductDescriptionCulture" /></summary>
        public const string Schema = "Production";
        /// <summary>Table Name constant for entity <see cref="AdventureWorks.Repository.Data.Entities.ProductModelProductDescriptionCulture" /></summary>
        public const string Name = "ProductModelProductDescriptionCulture";
    }

    internal readonly struct Columns
    {
        /// <summary>Column Name constant for property <see cref="AdventureWorks.Repository.Data.Entities.ProductModelProductDescriptionCulture.ProductModelId" /></summary>
        public const string ProductModelId = "ProductModelID";
        /// <summary>Column Name constant for property <see cref="AdventureWorks.Repository.Data.Entities.ProductModelProductDescriptionCulture.ProductDescriptionId" /></summary>
        public const string ProductDescriptionId = "ProductDescriptionID";
        /// <summary>Column Name constant for property <see cref="AdventureWorks.Repository.Data.Entities.ProductModelProductDescriptionCulture.CultureId" /></summary>
        public const string CultureId = "CultureID";
        /// <summary>Column Name constant for property <see cref="AdventureWorks.Repository.Data.Entities.ProductModelProductDescriptionCulture.ModifiedDate" /></summary>
