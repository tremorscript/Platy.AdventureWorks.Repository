...
/// <summary>
/// Allows configuration for an entity type <see cref="AdventureWorks.Repository.Data.Entities.ProductModelIllustration" />
/// </summary>
...
{
    /// <summary>
    /// Configures the entity of type <see cref="AdventureWorks.Repository.Data.Entities.ProductModelIllustration" />
    /// </summary>
    ...
    {
        /// <summary>Table Schema name constant for entity <see cref="AdventureWorks.Repository.Data.Entities.ProductModelIllustration" /></summary>
        public const string Schema = "Production";
        /// <summary>Table Name constant for entity <see cref="AdventureWorks.Repository.Data.Entities.ProductModelIllustration" /></summary>
        public const string Name = "ProductModelIllustration";
    }

    internal readonly struct Columns
    {
        /// <summary>Column Name constant for property <see cref="AdventureWorks.Repository.Data.Entities.ProductModelIllustration.ProductModelId" /></summary>
        public const string ProductModelId = "ProductModelID";
        /// <summary>Column Name constant for property <see cref="AdventureWorks.Repository.Data.Entities.ProductModelIllustration.IllustrationId" /></summary>
        public const string IllustrationId = "IllustrationID";
        /// <summary>Column Name constant for property <see cref="AdventureWorks.Repository.Data.Entities.ProductModelIllustration.ModifiedDate" /></summary>
