...
/// <summary>
/// Validator class for <see cref="VVendorWithAddressesCreateModel"/> .
/// </summary>
[RegisterSingleton<IValidator<VVendorWithAddressesCreateModel>>]
public partial class VVendorWithAddressesCreateModelValidator
    : AbstractValidator<VVendorWithAddressesCreateModel>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="VVendorWithAddressesCreateModelValidator"/> class.
    /// </summary>
    public VVendorWithAddressesCreateModelValidator()
    {
