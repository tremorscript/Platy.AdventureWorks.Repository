...
/// <summary>
/// Validator class for <see cref="VEmployeeCreateModel"/> .
/// </summary>
[RegisterSingleton<IValidator<VEmployeeCreateModel>>]
public partial class VEmployeeCreateModelValidator
    : AbstractValidator<VEmployeeCreateModel>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="VEmployeeCreateModelValidator"/> class.
    /// </summary>
    public VEmployeeCreateModelValidator()
    {
