...
/// </summary>
internal class PersonCreditCardConfiguration
  : IEntityTypeConfiguration<PersonCreditCard>
{
  /// <summary>
  ...
  internal readonly struct Table
  {
    ...
    /// <summary>
    ///   Table Name constant for entity <see cref="Platy.AdventureWorks.Repository.Data.Entities.PersonCreditCard" />
    /// </summary>
  ...
  internal readonly struct Columns
  {
    ...
    ///   <see cref="Platy.AdventureWorks.Repository.Data.Entities.PersonCreditCard.BusinessEntityId" />
    /// </summary>
    public const string BusinessEntityId = "BusinessEntityID";

    /// <summary>
    ///   Column Name constant for property
    ///   <see cref="Platy.AdventureWorks.Repository.Data.Entities.PersonCreditCard.CreditCardId" />
    /// </summary>
    public const string CreditCardId = "CreditCardID";

    /// <summary>
    ///   Column Name constant for property
    ///   <see cref="Platy.AdventureWorks.Repository.Data.Entities.PersonCreditCard.ModifiedDate" />
    /// </summary>
