...
/// </summary>
internal class BusinessEntityContactConfiguration
  : IEntityTypeConfiguration<BusinessEntityContact>
{
  /// <summary>
  ...
  internal readonly struct Columns
  {
    ...
    ///   <see cref="Platy.AdventureWorks.Repository.Data.Entities.BusinessEntityContact.BusinessEntityId" />
    /// </summary>
    public const string BusinessEntityId = "BusinessEntityID";

    /// <summary>
    ///   Column Name constant for property
    ///   <see cref="Platy.AdventureWorks.Repository.Data.Entities.BusinessEntityContact.PersonId" />
    /// </summary>
    public const string PersonId = "PersonID";

    /// <summary>
    ///   Column Name constant for property
    ///   <see cref="Platy.AdventureWorks.Repository.Data.Entities.BusinessEntityContact.ContactTypeId" />
    /// </summary>
    public const string ContactTypeId = "ContactTypeID";

    /// <summary>
    ///   Column Name constant for property
    ///   <see cref="Platy.AdventureWorks.Repository.Data.Entities.BusinessEntityContact.Rowguid" />
    /// </summary>
    public const string Rowguid = "rowguid";

    /// <summary>
    ///   Column Name constant for property
    ///   <see cref="Platy.AdventureWorks.Repository.Data.Entities.BusinessEntityContact.ModifiedDate" />
    /// </summary>
