...
/// </summary>
internal class ProductPhotoConfiguration
  : IEntityTypeConfiguration<ProductPhoto>
{
  /// <summary>
  ...
  internal readonly struct Table
  {
    ...
    /// <summary>
    ///   Table Name constant for entity <see cref="Platy.AdventureWorks.Repository.Data.Entities.ProductPhoto" />
    /// </summary>
  ...
  {
    /// <summary>
    ///   Column Name constant for property <see cref="Platy.AdventureWorks.Repository.Data.Entities.ProductPhoto.Id" />
    /// </summary>
    public const string Id = "ProductPhotoID";

    /// <summary>
    ///   Column Name constant for property
    ///   <see cref="Platy.AdventureWorks.Repository.Data.Entities.ProductPhoto.ThumbNailPhoto" />
    /// </summary>
    public const string ThumbNailPhoto = "ThumbNailPhoto";

    /// <summary>
    ///   Column Name constant for property
    ///   <see cref="Platy.AdventureWorks.Repository.Data.Entities.ProductPhoto.ThumbnailPhotoFileName" />
    /// </summary>
    public const string ThumbnailPhotoFileName = "ThumbnailPhotoFileName";

    /// <summary>
    ///   Column Name constant for property
    ///   <see cref="Platy.AdventureWorks.Repository.Data.Entities.ProductPhoto.LargePhoto" />
    /// </summary>
    public const string LargePhoto = "LargePhoto";

    /// <summary>
    ///   Column Name constant for property
    ///   <see cref="Platy.AdventureWorks.Repository.Data.Entities.ProductPhoto.LargePhotoFileName" />
    /// </summary>
    public const string LargePhotoFileName = "LargePhotoFileName";

    /// <summary>
    ///   Column Name constant for property
    ///   <see cref="Platy.AdventureWorks.Repository.Data.Entities.ProductPhoto.ModifiedDate" />
    /// </summary>
