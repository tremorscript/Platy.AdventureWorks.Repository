...
/// </summary>
internal class ProductModelIllustrationConfiguration
  : IEntityTypeConfiguration<ProductModelIllustration>
{
  /// <summary>
  ...
  internal readonly struct Columns
  {
    ...
    ///   <see cref="Platy.AdventureWorks.Repository.Data.Entities.ProductModelIllustration.ProductModelId" />
    /// </summary>
    public const string ProductModelId = "ProductModelID";

    /// <summary>
    ///   Column Name constant for property
    ///   <see cref="Platy.AdventureWorks.Repository.Data.Entities.ProductModelIllustration.IllustrationId" />
    /// </summary>
    public const string IllustrationId = "IllustrationID";

    /// <summary>
    ///   Column Name constant for property
    ///   <see cref="Platy.AdventureWorks.Repository.Data.Entities.ProductModelIllustration.ModifiedDate" />
    /// </summary>
