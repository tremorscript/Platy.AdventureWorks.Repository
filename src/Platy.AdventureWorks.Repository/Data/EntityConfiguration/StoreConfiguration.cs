  ...
  : IEntityTypeConfiguration<Store>
{
  ...
  {
    /// <summary>
    ///   Table Schema name constant for entity <see cref="Platy.AdventureWorks.Repository.Data.Entities.Store" />
    /// </summary>
  ...
  internal readonly struct Columns
  {
    ...
    ///   <see cref="Platy.AdventureWorks.Repository.Data.Entities.Store.BusinessEntityId" />
    /// </summary>
    public const string BusinessEntityId = "BusinessEntityID";

    /// <summary>
    ///   Column Name constant for property <see cref="Platy.AdventureWorks.Repository.Data.Entities.Store.Name" />
    /// </summary>
    public const string Name = "Name";

    /// <summary>
    ///   Column Name constant for property
    ///   <see cref="Platy.AdventureWorks.Repository.Data.Entities.Store.SalesPersonId" />
    /// </summary>
    public const string SalesPersonId = "SalesPersonID";

    /// <summary>
    ///   Column Name constant for property
    ///   <see cref="Platy.AdventureWorks.Repository.Data.Entities.Store.Demographics" />
    /// </summary>
    public const string Demographics = "Demographics";

    /// <summary>
    ///   Column Name constant for property <see cref="Platy.AdventureWorks.Repository.Data.Entities.Store.Rowguid" />
    /// </summary>
    public const string Rowguid = "rowguid";

    /// <summary>
    ///   Column Name constant for property
    ///   <see cref="Platy.AdventureWorks.Repository.Data.Entities.Store.ModifiedDate" />
    /// </summary>
