    ...
    IVProductModelCatalogDescriptionRepository
{
  ...
  /// </summary>
  public async Task<Result<IReadOnlyList<VProductModelCatalogDescriptionReadModel>>> List(
    CancellationToken cancellationToken)
  {
    return await QueryModel<VProductModelCatalogDescription, int>(null, cancellationToken);
  }
