...
/// <summary>
/// Validator class for <see cref="VSalesPersonUpdateModel"/> .
/// </summary>
[RegisterSingleton<IValidator<VSalesPersonUpdateModel>>]
public partial class VSalesPersonUpdateModelValidator
    : AbstractValidator<VSalesPersonUpdateModel>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="VSalesPersonUpdateModelValidator"/> class.
    /// </summary>
    public VSalesPersonUpdateModelValidator()
    {
