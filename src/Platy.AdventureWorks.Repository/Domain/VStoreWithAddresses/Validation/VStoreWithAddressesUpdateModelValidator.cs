...
/// <summary>
/// Validator class for <see cref="VStoreWithAddressesUpdateModel"/> .
/// </summary>
[RegisterSingleton<IValidator<VStoreWithAddressesUpdateModel>>]
public partial class VStoreWithAddressesUpdateModelValidator
    : AbstractValidator<VStoreWithAddressesUpdateModel>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="VStoreWithAddressesUpdateModelValidator"/> class.
    /// </summary>
    public VStoreWithAddressesUpdateModelValidator()
    {
