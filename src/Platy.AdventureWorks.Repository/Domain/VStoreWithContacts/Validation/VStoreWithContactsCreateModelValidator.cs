...
/// <summary>
/// Validator class for <see cref="VStoreWithContactsCreateModel"/> .
/// </summary>
[RegisterSingleton<IValidator<VStoreWithContactsCreateModel>>]
public partial class VStoreWithContactsCreateModelValidator
    : AbstractValidator<VStoreWithContactsCreateModel>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="VStoreWithContactsCreateModelValidator"/> class.
    /// </summary>
    public VStoreWithContactsCreateModelValidator()
    {
