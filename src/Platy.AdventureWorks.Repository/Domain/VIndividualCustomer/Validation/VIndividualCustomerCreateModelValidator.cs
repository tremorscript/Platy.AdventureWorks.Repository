...
/// <summary>
/// Validator class for <see cref="VIndividualCustomerCreateModel"/> .
/// </summary>
[RegisterSingleton<IValidator<VIndividualCustomerCreateModel>>]
public partial class VIndividualCustomerCreateModelValidator
    : AbstractValidator<VIndividualCustomerCreateModel>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="VIndividualCustomerCreateModelValidator"/> class.
    /// </summary>
    public VIndividualCustomerCreateModelValidator()
    {
