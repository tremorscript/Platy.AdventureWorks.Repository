...
/// <summary>
/// Validator class for <see cref="VIndividualCustomerUpdateModel"/> .
/// </summary>
[RegisterSingleton<IValidator<VIndividualCustomerUpdateModel>>]
public partial class VIndividualCustomerUpdateModelValidator
    : AbstractValidator<VIndividualCustomerUpdateModel>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="VIndividualCustomerUpdateModelValidator"/> class.
    /// </summary>
    public VIndividualCustomerUpdateModelValidator()
    {
